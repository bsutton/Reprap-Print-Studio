...
public class UnitConversion
{
	...
	static UnitConversion getUnitConversion(Units from, Units to)
	{
		...
		if (result == null)
			throw new IllegalArgumentException("Unsupported conversion attempted: " + from.toString() + " to " + to.toString());
	...
	, new UnitConversion(Units.inch, Units.meter, 0.0254F)
	, new UnitConversion(Units.inch, Units.micron, 25400F)
	
	, new UnitConversion(Units.feet, Units.millimeter, 304.8F)
	, new UnitConversion(Units.feet, Units.inch, 12)
	, new UnitConversion(Units.feet, Units.meter, 0.3048F)
	, new UnitConversion(Units.feet, Units.micron, 304800F)
