...
public class ByteBufferUtilities
{
      ...
      throws Exception
   {
      ...
      buffer.clear();
      ByteBufferUtilities.putUnsignedByte (buffer, 255);
      ByteBufferUtilities.putUnsignedByte (buffer, 128);
      ByteBufferUtilities.putUnsignedShort (buffer, 0xcafe);
      ByteBufferUtilities.putUnsignedInt (buffer, 0xcafebabe);
