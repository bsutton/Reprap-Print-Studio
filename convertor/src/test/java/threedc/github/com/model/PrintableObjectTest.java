		...
		try
		{
			...
			for (Vertex vertex : po.getVertexes())
			{
				...
				else
				{
					...
					Assert.assertEquals(-1.0F, vertex.getZ());
				}
				i++;
			}
			Assert.assertEquals(po.getVertexCount(), count + 1);
			...
			for (Vertex vertex : po.getVertexes())
			{
				...
				else
				{
					...
					Assert.assertEquals(2.0F, vertex.getX());
					Assert.assertEquals(2.0F, vertex.getY());
					Assert.assertEquals(2.0F, vertex.getZ());
				}
				i++;
			}
			Assert.assertEquals(po.getVertexCount(), 2);
